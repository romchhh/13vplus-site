...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-300 shadow-sm z-99999 lg:border-b">
              ...
              <div className="relative">
                ...
                <div className="relative" ref={containerRef}>
                  <input
                    ...
                    className="h-11 w-full rounded-lg border border-gray-300 bg-white py-2.5 pl-12 pr-14 text-sm text-gray-900 shadow-sm placeholder:text-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 xl:w-[430px]"
                  />
                ...
                <button className="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-300 bg-gray-100 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-700">
                  <span> ⌘ </span>
                  <span> K </span>
                </button>
              </div>
