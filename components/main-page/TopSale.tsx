      ...
      <div className="flex flex-col gap-12 lg:gap-16">
        ...
        <div className="sm:hidden -mx-4 px-4 relative">
          <Swiper
            ...
            initialSlide={0}
            navigation={{
              nextEl: ".swiper-button-next-topsale",
              prevEl: ".swiper-button-prev-topsale",
            }}
            breakpoints={{
          ...
          <button className="swiper-button-prev-topsale absolute left-2 top-1/2 -translate-y-1/2 z-10 text-black hover:text-black/80 transition-colors duration-200">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M15 18l-6-6 6-6"/>
            </svg>
          </button>
          <button className="swiper-button-next-topsale absolute right-2 top-1/2 -translate-y-1/2 z-10 text-black hover:text-black/80 transition-colors duration-200">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
