      ...
      <div className="flex flex-col items-center gap-6 lg:gap-8">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="py-6 border-t border-black/20">
            <p className="text-2xl font-medium font-['Montserrat'] text-black leading-relaxed mb-6">
              Що для нас важливо
            </p>
          ...
          <div className="mt-8 space-y-6">
            <div className="pt-6 pb-3 border-t border-black/20">
              ...
              <p className="text-xl font-normal font-['Montserrat'] text-black/70 leading-relaxed mb-4 text-justify">
              ...
              <p className="text-2xl font-medium font-['Montserrat'] text-black leading-relaxed mt-8">
