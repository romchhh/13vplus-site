...
export default function Footer() {
  return (
    <footer className="w-full bg-white text-black border-t border-black/10">
      {/* Main footer content */}
      <div className="max-w-[1920px] mx-auto px-6 py-16 lg:py-20">
          ...
          <div className="flex flex-col items-center justify-center gap-3 text-center">
            ...
            <div className="pt-2">
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-base sm:text-lg font-semibold font-['Montserrat'] text-black hover:text-black/70 transition-colors tracking-wide"
              >
